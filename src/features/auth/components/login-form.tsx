    ...
    <div className="login-split">
      ...
      >
        ...
        <div className="login-mobile-hero-text">
          ...
          <p className="login-title" style={{ color: "#fff" }}>Obra Manager</p>
          <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "0.875rem" }}>Control digital de construcción</p>
        </div>
      </div>
      ...
      <div className="login-slider-panel">
        ...
        <div className="login-welcome-wrap">
          <div className="login-welcome-text">
            <p className="login-eyebrow">Plataforma profesional</p>
            <h1 className="login-hero-title">
              Gestión de obras,<br />al siguiente nivel.
            </h1>
            <p className="login-hero-sub">
              Controlá presupuestos, avance de etapas<br />y equipos desde un solo lugar.
            </p>
            <div className="login-dots" role="tablist" aria-label="Navegación de imágenes">
              {slides.map((_, i) => (
                <button
                  key={i}
                  role="tab"
      ...
      <div className="login-form-panel">
        <div className="login-form-inner">
          ...
          <div className="login-brand">
            ...
            <h2 className="login-title">Obra Manager</h2>
